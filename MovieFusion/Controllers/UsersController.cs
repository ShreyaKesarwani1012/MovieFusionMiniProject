...
namespace MovieFusion.Controllers
{
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("UId,Name,Email,Password,City,Phone")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UId,Name,Email,Password,City,Phone")] User user)
        {
            if (id != user.UId)
            {
                return NotFound();
